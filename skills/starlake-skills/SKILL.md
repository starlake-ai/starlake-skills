...
- [expectations](../expectations/SKILL.md): Data quality expectations syntax, built-in macros, and validation patterns.
...
- [settings](../settings/SKILL.md): Print settings or test a connection (includes all connection types).
...
- [secure](../secure/SKILL.md): Apply security policies (RLS/CLS/Privacy).
...
- [dag-generate](../dag-generate/SKILL.md): Generate Airflow/Dagster DAGs.
